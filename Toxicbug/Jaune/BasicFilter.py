# -*- coding: utf-8 -*-
"""
Created on Wed Jan 31 20:55:22 2018
Name: Jaune 
Date: Feb 2
Title: Photo
Purpose:Studying 
...
def Takephoto():
    ...
    while True:
        ...
        k = cv2.waitKey(1)
        if k%256 == 27:
            #To exit the camera, pressing ESC.
            print("Escape hit, closing...")
            break
        elif k%256 == 32:
            if flag == 0:
                img_name = "BasicPhoto.PNG" #This lets the camera take a photo when pressing SPACE.
                cv2.imwrite(img_name, frame)#This saves the photo.
                flag+=1
            if flag==1:
                img_name = "ActivePhoto.PNG"
